...
- Is there something that could be simplified with modules?
...
Let's look at the examples in https://github.com/danielinteractive/useR2022/blob/main/testing/README.md
<!-- TODO: need to integrate into examples folder, include the Apache 2 LICENSE file -->

- Read and execute `ex1-testServer.R`. Play around with setting different UI inputs and adding additional server tests.
- Read and execute `ex2-ShinyDriver.R`. Add a small additional feature to the app and test it.
- Have a look at `ex3-test_module.R`. What is different here? Record some additional tests and integrate them into the code.
<!-- TODO: need to adapt no. 2 and 3 to shinytest2 -->
