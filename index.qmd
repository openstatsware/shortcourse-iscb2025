...
This event is organized by [Zurich R Courses](https://www.zhrcourses.uzh.ch/en.html) and [RCONIS](https://rconis.com/). The presenter in this workshop will be Daniel Sabanés Bové.
...
-   Install additional R packages using the [installation script](examples/install.R).
