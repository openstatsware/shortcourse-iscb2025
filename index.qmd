...
The next event will be held in October 2023 as an in-person workshop in Montreal, Canada.
Please register [here](https://todo.com) by TODO.

This event is organized by McGill University and the ASA BIOP Software Engineering Working Group (SWE WG). We are grateful to have received logistic support by McGill University. Presenters will be Doug Kelkhoff, Philippe Boileau and Daniel Sabanes Bove.
