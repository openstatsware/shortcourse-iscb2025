...
The next event will be held on September 26, 2023 as an in-person workshop at the George Washington University, Rockville, MD, US.
Please register [here](https://todo.com) by TODO.

This event is organized by the ASA BIOP Software Engineering Working Group (SWE WG) as well as the ASA. We are grateful to have received logistic support by ASA BIOP and ASA. The venue is kindly provided by the George Washington University Biostatistics Center. Presenters will be Andrew Bean, Biju Wang and Daniel Sabanes Bove.
