...
-   Statistician at Novartis for 6 years: Advanced Exploratory Analytics
-   Open-source contributions include R package `OncoBayes2` (Bayesian model-based dose escalation)
-   Member of ASA BIOP working group on Software Engineering (SWE WG), including Bayesian MMRM workstream
...
-   Member of ASA BIOP working group on Software Engineering (SWE WG)
-   Feel free to connect 
    [`r fontawesome::fa("linkedin")`](https://www.linkedin.com/in/bijuwang/) 
    [`r fontawesome::fa("github")`](https://github.com/bijuwang)
:::
...
-   Course website at [openpharma.github.io/workshop-r-swe-md](https://openpharma.github.io/workshop-r-swe-md)
    -   all slides
    -   sources available at [github.com/openpharma/workshop-r-swe-md](https://github.com/openpharma/workshop-r-swe-md)
